(self.webpackChunkresume_builder_frontend =
  self.webpackChunkresume_builder_frontend || []).push([
  [732],
  {
    588: function (t) {
      (function () {
    ...
    732: (t, e, r) => {
      ...
      r.r(e),
        r.d(e, {
          ...
          Element: () => Mt,
          EllipseElement: () => qt,
          FeColorMatrixElement: () => Ce,
          FeCompositeElement: () => _e,
          FeDropShadowElement: () => Ne,
          FeGaussianBlurElement: () => ke,
          FeMorphologyElement: () => Ve,
          FilterElement: () => Me,
          Font: () => Rt,
          FontElement: () => oe,
          FontFaceElement: () => he,
      ...
      function f(t, e, r) {
        ...
        var o = g([(e - s) / 2, (r - a) / 2], (-t.xRot / 180) * p),
          h = o[0],
          l = o[1],
          u = Math.pow(h, 2) / Math.pow(i, 2) + Math.pow(l, 2) / Math.pow(n, 2);
        1 < u && ((i *= Math.sqrt(u)), (n *= Math.sqrt(u))),
          (t.rX = i),
          (t.rY = n);
        var c =
            Math.pow(i, 2) * Math.pow(l, 2) + Math.pow(n, 2) * Math.pow(h, 2),
          d =
            (t.lArcFlag !== t.sweepFlag ? 1 : -1) *
            Math.sqrt(Math.max(0, (Math.pow(i, 2) * Math.pow(n, 2) - c) / c)),
          f = ((i * l) / n) * d,
          y = ((-n * h) / i) * d,
          m = g([f, y], (t.xRot / 180) * p);
        (t.cX = m[0] + (e + s) / 2),
          (t.cY = m[1] + (r + a) / 2),
          (t.phi1 = Math.atan2((l - y) / n, (h - f) / i)),
          (t.phi2 = Math.atan2((-l - y) / n, (-h - f) / i)),
          0 === t.sweepFlag && t.phi2 > t.phi1 && (t.phi2 -= 2 * p),
          1 === t.sweepFlag && t.phi2 < t.phi1 && (t.phi2 += 2 * p),
          (t.phi1 *= 180 / p),
          (t.phi2 *= 180 / p);
      }
      function y(t, e, r) {
      ...
      !(function (t) {
              ...
              if (
                ...
                if (0 === y)
                  ...
                  var m = (n.xRot * Math.PI) / 180,
                    ...
                    O = w * r * r - T * t * r + A * t * t,
                    M = ((Math.atan2(P, C - O) + Math.PI) % Math.PI) / 2,
                    N = Math.sin(M),
                    V = Math.cos(M);
                  (n.rX =
                    Math.abs(y) / Math.sqrt(C * f(V) + P * N * V + O * f(N))),
                    (n.rY =
                      Math.abs(y) / Math.sqrt(C * f(N) - P * N * V + O * f(V))),
        ...
        (t.ROUND = function (t) {
          ...
          (t.ROTATE = function (t, e, r) {
            void 0 === e && (e = 0), void 0 === r && (r = 0), d(t, e, r);
            var i = Math.sin(t),
              n = Math.cos(t);
            return s(n, i, -i, n, e - e * n + r * i, r - e * i - r * n);
          }),
          (t.TRANSLATE = function (t, e) {
            return void 0 === e && (e = 0), d(t, e), s(1, 0, 0, 1, t, e);
          }),
          (t.SCALE = function (t, e) {
            return void 0 === e && (e = t), d(t, e), s(t, 0, 0, e, 0, 0);
          }),
          (t.SKEW_X = function (t) {
            return d(t), s(1, 0, Math.atan(t), 1, 0, 0);
          }),
          (t.SKEW_Y = function (t) {
            return d(t), s(1, Math.atan(t), 0, 1, 0, 0);
          }),
          (t.X_AXIS_SYMMETRY = function (t) {
            return void 0 === t && (t = 0), d(t), s(-1, 0, 0, 1, t, 0);
          }),
          (t.Y_AXIS_SYMMETRY = function (t) {
            return void 0 === t && (t = 0), d(t), s(1, 0, 0, -1, 0, t);
          }),
          (t.A_TO_C = function () {
            return n(function (t, e, r) {
              return E.ARC === t.type
                ? (function (t, e, r) {
                    ...
                    for (
                      ...
                      var y = x(t.phi1, t.phi2, p / l),
                        m = x(t.phi1, t.phi2, (p + 1) / l),
                        b = m - y,
                        S = (4 / 3) * Math.tan((b * v) / 4),
                        w = [
                          Math.cos(y * v) - S * Math.sin(y * v),
                          Math.sin(y * v) + S * Math.cos(y * v),
                        ],
                        T = w[0],
                        A = w[1],
                        C = [Math.cos(m * v), Math.sin(m * v)],
                        P = C[0],
                        O = C[1],
                        M = [P + S * Math.sin(m * v), O - S * Math.cos(m * v)],
                        N = M[0],
                        V = M[1];
                      u[p] = { relative: t.relative, type: E.CURVE_TO };
                      var _ = function (e, r) {
          ...
          (t.CALCULATE_BOUNDS = function () {
            var t = e(),
              ...
              o = n(function (e, r, i) {
                ...
                if (
                  (n.type & E.DRAWING_COMMANDS && (h(r), l(i)),
                  n.type & E.HORIZ_LINE_TO && h(n.x),
                  n.type & E.VERT_LINE_TO && l(n.y),
                  n.type & E.LINE_TO && (h(n.x), l(n.y)),
                  n.type & E.CURVE_TO)
                ) {
                  h(n.x), l(n.y);
                  for (var u = 0, c = S(r, n.x1, n.x2, n.x); u < c.length; u++)
                    0 < (k = c[u]) && 1 > k && h(w(r, n.x1, n.x2, n.x, k));
                  for (var g = 0, d = S(i, n.y1, n.y2, n.y); g < d.length; g++)
                    0 < (k = d[g]) && 1 > k && l(w(i, n.y1, n.y2, n.y, k));
                }
                if (n.type & E.ARC) {
                  h(n.x), l(n.y), f(n, r, i);
                  for (
                    var p = (n.xRot / 180) * Math.PI,
                      m = Math.cos(p) * n.rX,
                      v = Math.sin(p) * n.rX,
                      x = -Math.sin(p) * n.rY,
                      T = Math.cos(p) * n.rY,
                    ...
                    (k = N[M]) > C && k < P && h(b(n.cX, m, x, k));
                  for (var V = 0, _ = y(T, -v, 0).map(O); V < _.length; V++) {
                    var k;
                    (k = _[V]) > C && k < P && l(b(n.cY, v, T, k));
                  }
                }
                return e;
              });
        ...
        A = (function () {
          ...
          return (
            (t.prototype.round = function (t) {
              return this.transform(m.ROUND(t));
            }),
            (t.prototype.toAbs = function () {
              return this.transform(m.TO_ABS());
            }),
            (t.prototype.toRel = function () {
              return this.transform(m.TO_REL());
            }),
            (t.prototype.normalizeHVZ = function (t, e, r) {
              return this.transform(m.NORMALIZE_HVZ(t, e, r));
            }),
            (t.prototype.normalizeST = function () {
              return this.transform(m.NORMALIZE_ST());
            }),
            (t.prototype.qtToC = function () {
              return this.transform(m.QT_TO_C());
            }),
            (t.prototype.aToC = function () {
              return this.transform(m.A_TO_C());
            }),
            (t.prototype.sanitize = function (t) {
              return this.transform(m.SANITIZE(t));
            }),
            (t.prototype.translate = function (t, e) {
              return this.transform(m.TRANSLATE(t, e));
            }),
            (t.prototype.scale = function (t, e) {
              return this.transform(m.SCALE(t, e));
            }),
            (t.prototype.rotate = function (t, e, r) {
              return this.transform(m.ROTATE(t, e, r));
            }),
            (t.prototype.matrix = function (t, e, r, i, n, s) {
              return this.transform(m.MATRIX(t, e, r, i, n, s));
            }),
            (t.prototype.skewX = function (t) {
              return this.transform(m.SKEW_X(t));
            }),
            (t.prototype.skewY = function (t) {
              return this.transform(m.SKEW_Y(t));
            }),
            (t.prototype.xSymmetry = function (t) {
              return this.transform(m.X_AXIS_SYMMETRY(t));
            }),
            (t.prototype.ySymmetry = function (t) {
              return this.transform(m.Y_AXIS_SYMMETRY(t));
            }),
            (t.prototype.annotateArcs = function () {
              return this.transform(m.ANNOTATE_ARCS());
            }),
            t
          );
        })(),
        ...
        if (!(isNaN(s) || s < 1)) {
          ...
          (a = (function (t, e, r, i, n, s) {
            for (
              ...
              (p = p.next = new I()), f === c && (a = p);
            p.next = d;
            for (
              var y = null, m = null, v = 0, x = 0, b = V[s], S = _[s], w = 0;
              w < n;
              w++
            ) {
              p = d;
      ...
      var F = /^[A-Z-]+$/;
      function U(t) {
        return F.test(t) ? t.toLowerCase() : t;
      }
      function X(t) {
        var e = /url\(('([^']+)'|"([^"]+)"|([^'")]+))\)/.exec(t) || [];
        return e[2] || e[3] || e[4];
        ...
        getColor(t) {
          ...
          return (
            this.isNormalizedColor ||
              ((this.isNormalizedColor = !0), (e = Y(e)), (this.value = e)),
            e
          );
        }
        getDpi() {
      ...
      class dt {
        ...
        static parsePath(t) {
          for (var e = H(t), r = e.length, i = [], n = 0; n < r; n += 2)
            i.push(new dt(e[n], e[n + 1]));
          return i;
        }
        angleTo(t) {
      ...
      var ft = "undefined" !== typeof window ? window : null,
        yt = "undefined" !== typeof fetch ? fetch.bind(void 0) : null;
      class mt {
        constructor(t) {
          var { fetch: e = yt, window: r = ft } =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
          (this.ctx = t),
            (this.FRAMERATE = 30),
        ...
        setViewBox(t) {
          ...
          "meet" === x && ((A *= w), (C *= w)),
            "slice" === x && ((A *= T), (C *= T));
          var P = new ct(e, "refX", u),
            O = new ct(e, "refY", c),
            E = P.hasValue() && O.hasValue();
          if (
            (E && r.translate(-w * P.getPixels("x"), -w * O.getPixels("y")), g)
          ) {
            var M = w * d,
              N = w * p;
            r.beginPath(),
        ...
        start(t) {
          ...
          if (
            ...
            this.isReady() && this.render(t, n, s, o, l, u, c),
            e)
          ) {
            var f = Date.now(),
              y = f,
                ...
                (f = Date.now()),
                  (m = f - y) >= p &&
                    ...
                    this.shouldUpdate(i, a) &&
                      (this.render(t, n, s, o, l, u, c), d.runEvents())),
                  (this.intervalId = h(v));
              };
        ...
        render(t, e, r, i, n, s, a) {
          ...
          if (
            ...
            var m = H(t.getAttribute("viewBox").getString()),
              v = 0,
              x = 0;
            if ("number" === typeof i) {
          ...
          r || u.clearRect(0, 0, f, y),
            t.render(u),
            c && (this.isFirstRender = !1);
        }
      }
      (mt.defaultWindow = ft), (mt.defaultFetch = yt);
      var { defaultFetch: vt } = mt,
        xt = "undefined" !== typeof DOMParser ? DOMParser : null;
      class bt {
        constructor() {
          var { fetch: t = vt, DOMParser: e = xt } =
      ...
      class Rt {
        constructor(t, e, r, i, n, s) {
          var a = s ? ("string" === typeof s ? Rt.parse(s) : s) : {};
        ...
        static parse() {
          ...
          return (
            a.forEach((t) => {
              switch (!0) {
                case !o.fontStyle && Rt.styles.includes(t):
                  "inherit" !== t && (e = t), (o.fontStyle = !0);
                  break;
                case !o.fontVariant && Rt.variants.includes(t):
                  "inherit" !== t && (r = t),
                    (o.fontStyle = !0),
                    (o.fontVariant = !0);
                  break;
                case !o.fontWeight && Rt.weights.includes(t):
                  "inherit" !== t && (i = t),
                    (o.fontStyle = !0),
                    (o.fontVariant = !0),
                    (o.fontWeight = !0);
      ...
      (Rt.styles = "normal|italic|oblique|inherit"),
        (Rt.variants = "normal|small-caps|inherit"),
        (Rt.weights =
      ...
      class Lt extends E {
        ...
        reset() {
          (this.i = -1),
            (this.command = null),
            (this.previousCommand = null),
            (this.start = new dt(0, 0)),
            (this.control = new dt(0, 0)),
            (this.current = new dt(0, 0)),
            (this.points = []),
            (this.angles = []);
        }
        isEnd() {
          ...
          var t =
            ...
            e =
              arguments.length > 1 && void 0 !== arguments[1]
                ? arguments[1]
                : "y",
            r = new dt(this.command[t], this.command[e]);
      ...
      class Bt extends Dt {
        ...
        static pathH(t) {
          var { current: e, command: r } = t,
            i = new dt((r.relative ? e.x : 0) + r.x, e.y);
        ...
        static pathV(t) {
          var { current: e, command: r } = t,
            i = new dt(e.x, (r.relative ? e.y : 0) + r.y);
          return (t.current = i), { current: e, point: i };
        }
        pathV(t, e) {
          var { pathParser: r } = this,
        ...
        static pathA(t) {
          var { current: e, command: r } = t,
            ...
            c =
              Math.pow(u.x, 2) / Math.pow(i, 2) +
              Math.pow(u.y, 2) / Math.pow(n, 2);
        ...
        pathA(t, e) {
          var { pathParser: r } = this,
            ...
            c = 1 - a ? 1 : -1,
            g = l + c * (u / 2),
            d = new dt(h.x + n * Math.cos(g), h.y + s * Math.sin(g));
          if (
      ...
      class Ht extends Dt {
        ...
        getFontSize() {
          var { document: t, parent: e } = this,
            r = Rt.parse(t.ctx.font).fontSize;
          ...
          if (i) {
            for (
              var n = this.getFontSize(),
                ...
                a = H(r.getAttribute("dx").getString()),
                o = s.length,
                h = 0,
                l = 0;
              l < o;
              ...
              (h +=
                ((this.getGlyph(i, s, l).horizAdvX || i.horizAdvX) * n) /
        ...
        getInheritedAttribute(t) {
          for (var e = this; e instanceof Ht && e.isFirstChild(); ) {
      ...
      class Xt extends Dt {
        ...
        setContext(t) {
          ...
          if (
            ...
            var a = new ct(r, "fontSize", Rt.parse(t.font).fontSize);
            a.hasValue() &&
          ...
          var l = this.getAttribute("refX"),
            ...
            g = c.hasValue() ? H(c.getString()) : null,
            d =
              !this.root &&
      ...
      class $t extends Mt {
        ...
        createPattern(t, e, r) {
          ...
          for (var u = -1; u <= 1; u++)
            for (var c = -1; c <= 1; c++)
              o.save(),
                (s.attributes.x = new ct(this.document, "x", u * a.width)),
        ...
        render(t, e, r) {
          if (e) {
            ...
            t.translate(i, n),
              ...
              t.save();
            var o = new Xt(this.document, null);
            (o.type = this.type),
        ...
        createGradient(t, e, r) {
          ...
          if (
            ...
            var { document: a } = this,
              ...
              [l] = h.viewPorts,
              u = new Yt(a, null);
            (u.attributes.x = new ct(a, "x", -o / 3)),
              (u.attributes.y = new ct(a, "y", -o / 3)),
              (u.attributes.width = new ct(a, "width", o)),
              (u.attributes.height = new ct(a, "height", o));
            var c = new Jt(a, null);
            ...
            (g.attributes.x = new ct(a, "x", 0)),
              ...
              (g.attributes.width = new ct(a, "width", l.width)),
              (g.attributes.height = new ct(a, "height", l.height)),
              (g.children = [c]);
            var d = a.createCanvas(l.width, l.height),
              p = d.getContext("2d");
            return (
              (p.fillStyle = s), g.render(p), p.createPattern(d, "no-repeat")
            );
          }
          return s;
        }
        ...
        renderChildren(t) {
          if (this.hasText) {
            ...
            var { document: e, x: r, y: i } = this,
              { mouse: n } = e.screen,
              s = new ct(e, "fontSize", Rt.parse(e.ctx.font).fontSize);
            n.isWorking() &&
              n.checkBoundingBox(
                this,
      ...
      class pe extends Ht {
        ...
        findSegmentToFitChar(t, e, r, i, n, s, a, o, h) {
          ...
          if (a) {
            var y = Math.cos(Math.PI / 2 + f) * a,
              m = Math.cos(-f) * a;
            (p.p0 = de(de({}, g), {}, { x: g.x + y, y: g.y + m })),
              (p.p1 = de(de({}, d), {}, { x: d.x + y, y: d.y + m }));
          }
        ...
        setTextData(t) {
          if (!this.glyphInfo) {
            ...
            for (var g = 0; g < c; g++)
              u.push("undefined" !== typeof n[g] ? n[g] : l);
        ...
        getPointOnLine(t, e, r, i, n) {
          ...
          var l = o * h,
            u = null;
          if (i === e) u = { x: s, y: a + l };
          else if ((a - r) / (s - e + tt) === o) u = { x: s + h, y: a + l };
          else {
            var c,
              g,
        ...
        getPointOnQuadraticBezier(t, e, r, i, n, s, a) {
          return {
            x: s * ht(t) + i * lt(t) + e * ut(t),
            y: a * ht(t) + n * lt(t) + r * ut(t),
          };
        }
      ...
      class be extends Dt {
        ...
        renderChildren(t) {
          ...
          if (r) {
            ...
            if (
              ("symbol" === r.type &&
                (((i = new Xt(e, null)).attributes.viewBox = new ct(
                  e,
                  "viewBox",
      ...
      class Ce extends Mt {
        constructor(t, e, r) {
          ...
          var i = H(this.getAttribute("values").getString());
        ...
        apply(t, e, r, i, n) {
          for (
            ...
            for (var l = 0; l < i; l++) {
              var u = Se(o.data, l, h, i, 0, 0),
                c = Se(o.data, l, h, i, 0, 1),
                g = Se(o.data, l, h, i, 0, 2),
                d = Se(o.data, l, h, i, 0, 3),
                p =
                  Te(a, 0, u) +
                  Te(a, 1, c) +
                  Te(a, 2, g) +
              ...
              s && ((p = 0), (f = 0), (y = 0), (m *= d / 255)),
                we(o.data, l, h, i, 0, 0, p),
                we(o.data, l, h, i, 0, 1, f),
                we(o.data, l, h, i, 0, 2, y),
                we(o.data, l, h, i, 0, 3, m);
            }
      ...
      class Pe extends Mt {
        ...
        apply(t, e) {
          ...
          var h = this.removeStyles(e, Pe.ignoreStyles),
      ...
      Pe.ignoreStyles = ["mask", "transform", "clip-path"];
      var Oe = () => {};
      class Ee extends Mt {
        constructor() {
          ...
          if (n) {
            ...
            if (!(l < 1 || u < 1)) {
              var c = Math.floor(n.x),
                g = Math.floor(n.y),
                d = this.removeStyles(e, Me.ignoreStyles),
      ...
      class Ue {
        ...
        fork(t, e) {
          var r =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
          return Ue.from(t, e, Fe(Fe({}, this.options), r));
        }
        forkString(t, e) {
          var r =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
          return Ue.fromString(t, e, Fe(Fe({}, this.options), r));
        }
        ready() {
        ...
        render() {
          ...
          return n(function* () {
            ...
            e.start(
              Fe({ enableRedraw: !0, ignoreAnimation: !0, ignoreMouse: !0 }, r)
            ),
              yield e.ready(),
              e.stop();
          })();
        ...
        start() {
          ...
          r.start(e, Fe(Fe({ enableRedraw: !0 }, i), t));
        }
        stop() {
          this.screen.stop();
        }
...
//# sourceMappingURL=732.77ff776e.chunk.js.map
