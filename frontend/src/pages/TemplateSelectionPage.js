...
const templates = [
  {
    ...
    pdfUrl: `${process.env.PUBLIC_URL}/components/ClassicTemplate.html`,
  },
  {
    id: 2,
    name: "Modern Template",
    pdfUrl: `${process.env.PUBLIC_URL}/components/temp2.html`,
  },
  {
    id: 3,
    name: "Creative Template",
    pdfUrl: `${process.env.PUBLIC_URL}/components/temp3.html`,
  },
];
      ...
      <div className="template-grid">
        {templates.map((template) => (
          <div
            ...
            <h3>{template.name}</h3>
            <button onClick={() => handlePreview(template.pdfUrl)}>
              Preview
            </button>
          </div>
        ))}
